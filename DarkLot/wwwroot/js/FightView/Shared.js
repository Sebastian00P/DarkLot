        ...
        <div class="battle-card">
          <div class="battle-header">
            ...
            <div class="battle-meta">
              ...
              <span class="material-icons favorite-btn ${b.isFavorite ? ' active' : ''}" data-id="${b.id}">favorite</span>
              <span class="material-icons share-btn ${b.isShared ? ' active' : ''}" data-id="${b.id}">share</span>
            </div>
          </div>
